...
/**
 * From http://www.java2s.com Copyright 2013 Valentyn Kolesnikov Licensed under the Apache
 * License,Version2.0(the"License"); you may not use this file except in compliance with the
